...
set(toolchain_COMMIT "$Format:%H$")

if(NOT ${toolchain_COMMIT} MATCHES "^[a-f0-9]+$")
    execute_process(
        COMMAND git -C ${RiscvToolchainForEmbedded_SOURCE_DIR} rev-parse HEAD
        OUTPUT_VARIABLE toolchain_COMMIT
...
if(NOT (LLVM_TOOLCHAIN_C_LIBRARY STREQUAL llvmlibc)) # libc in a separate repo?
    ...
    set(LLVM_TOOLCHAIN_C_LIBRARY_COMMIT ${toolchain_COMMIT})
endif()
